...
def usage():
    ...
    print "#-------------------------------------------------------#"
    print "#   \033[1;91mCommand: " "python2 zu1x73y.py " "<ip> <port> <packet> \033[1;32m   #"
    print "#                                                       #"
    print "#\033[1;91mCreator:anjay   \033[1;32m##      ###       ##                #"
    print "#\033[1;91mTeam  : zu1x73y       \033[1;32m##     #          ##                #"
    print "#\033[1;91mVersion:2.0        \033[1;32m##      ###       ##                #"
    print "#                   ## \033[1;91m ##     \033[1;32m#  \033[1;91m##  \033[1;32m##                #"
    print "#                   ##  \033[1;91m##  \033[1;32m###   \033[1;91m##  \033[1;32m######            #"
    print "#               \033[1;91m<--[zu1x73y]-->         \033[1;32m#"
    print "======================================================================="
    print "                          zu1x73y"
    print "                       @@@@@@@@@@@@"
    print "                     @@@@@@@@@@@@@@@@"
